...
// following each with a space (including the last). Print forwards, then backwards.
//End with newline.

//Ex: If courseGrades = {7, 9, 11, 10},
...
// This activity will perform two tests,
// both with a 4-element vector (vector<int> courseGrades(4)).
//See "How to Use zyBooks".

//Also note: If the submitted code tries to access an invalid vector element,
// such as courseGrades.at(9) for a 4-element vector,
