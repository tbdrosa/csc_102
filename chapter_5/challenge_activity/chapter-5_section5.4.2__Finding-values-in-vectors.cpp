...
// assign numMatches with the number of elements in userValues that equal matchValue. u
//serValues has NUM_VALS elements.

//Ex: If userValues is {2, 2, 1, 2} and matchValue is 2 ,
