// The goal of this challenge activity is to Complete the second PrintSalutation function
// in order to print the following given personName "Holly" and customSalutation "Welcome":
